...
class Events extends Component {
  ...
  render() {
    const {initialEventList, registrationStatus} = this.state
    console.log(registrationStatus)
    return (
      <div className="mainContainer">
        <ul className="eventItems">
          <h1 className="ulMainHeading">Events</h1>
          {initialEventList.map(eachObj => (
            <EvenItem
        ...
        <div className="activeEvent">
          <ActiveEvent status={registrationStatus} />
        </div>
      </div>
    )
  }
